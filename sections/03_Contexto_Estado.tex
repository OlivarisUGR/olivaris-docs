...
Para la comunicación entre estos componentes, se ha implementado una \textbf{API REST}, consolidada como el estándar ``de facto'' por su simplicidad y 
...
Además, a diferencia de una arquitectura distribuida, las transacciones realizadas con un monolito sobre la base de datos son más rápidas y el desarrollo es más ágil, permitiendo evolucionar el 
sistema sin romper contratos entre servicios independientes y evitando gestionar fallos distribuidos, lo cual resultaría costoso y complejo para el alcance de este proyecto.
...
\begin{itemize}
    ...
    Por otro lado, Java dispone de bibliotecas muy completas para la generación de PDF y, si en el futuro se incorporan nuevas funcionalidades, ofrece una buena 
    capacidad de escalado, por ejemplo mediante la integración con sensores IoT.

    También he elegido esta tecnología porque Java y Spring Boot siguen teniendo una alta demanda en el mercado laboral, por lo que considero que este proyecto es 
