...
\begin{itemize}
    \item \textbf{Horas trabajadas:} las horas trabajadas han sido de aproximadamente 320 horas. Estas horas incluyen tanto la realización de todas las tareas
    fijadas para cada sprint, realización de la memoria e investigación de las herramientas utilizadas.

    \item \textbf{Precio por hora:} según la página de \textbf{Glassdoor} \cite{glassdoor}, el sueldo base se encuentra en el rango de 17.000€ - 22.000€ brutos anuales,
    lo que se traduce en un total de 1.416'66€ - 1.833'33€ brutos al mes divididos en 12 pagas mensuales. 
    
    Los cálculos se van a realizar cogiendo el rango superior (22.000€), ya que este desarrollo ha sido realizado por un futuro ingeniero. De esta forma, se tienen 11.46€/h
    aproximadamente.

    Realizando los cálculos adecuados, se obtiene un total de \textbf{3.667'2€} en total.  
\end{itemize}
...
El servidor con estas características tiene un precio de \textbf{48€} trimestrales. Como el despliegue se hizo durante la fase final del proyecto, con los 3 meses alquilados es suficiente ahora mismo.
...
3.667'2€ (coste personal) + 48€ (servidor CSIRC) + 278€ (gasto de suministros) = \textbf{3.993'2€}