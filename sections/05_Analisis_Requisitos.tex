...
Antes de comenzar con el desarrollo y la implementación del sistema, es necesario llevar a cabo una fase previa de análisis. 
En esta etapa se identificarán y definirán los requisitos que deberá cumplir el sistema, así como las funcionalidades que 
ofrecerá. A continuación, se describe el proceso seguido para realizar esta fase.
...
Para obtener información sobre el CUE, se han accedido a los siguientes anexos del SIEX:
...
\begin{itemize}
    ...
    \item \textbf{Anexo III - Registros de los tratamientos fitosanitarios y de fertilización (BOE):} este anexo se ha utilizado para investigar sobre qué datos de una
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/03_persona1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/03_persona2.png}
...
Además de la historia de usuario, se ha añadido el identificador de esa historia de usuario y un título.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Dado que la actividad contenía datos en tablas específicas, entonces los datos asociados se eliminan.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{RF-08.10.3)} Un usuario con rol de ``administrador'' podrá registrar actividades para sí mismo en caso de no pertenecer a una entidad como agricultor.
    \end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{RNF3.2)} El sistema debe estar documentado de forma adecuada, de manera que pueda permitir
