...
A partir de estas historias de usuario se han extraído los siguientes requisitos funcionales agrupados por áreas. La estructura va a ser del tipo \textit{RF-[ID de HU].XX}.
