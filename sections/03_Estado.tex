...
La infraestructura moderna se basa en el paradigma de Cloud Computing y la Virtualización. El objetivo es que la aplicación 
sea escalable, resiliente y que su despliegue sea totalmente automatizado a través de pipelines de CI/CD (Integración Continua 
y Despliegue Continuo). Entre las principales tecnologías más utilizadas en la actualidad se encuentran:

\begin{itemize}
    \item Contenedores (Docker)
    \item Orquestación (Kubernetes)
    \item Infraestructura como código (Ansible)
\end{itemize}

Además de esto, el desarrollo de un buen sistema requiere de una seguridad constante que evite el acceso a datos cŕiticos del 
sistema. Para ello, la autenticación y autorización juegan un papel fundamental en este apartado, destacando principalmente:

HABLAR DE LOS TIPOS DE AUTENTICACIÓN
