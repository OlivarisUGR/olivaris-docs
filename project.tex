...
\begin{document}
    ...
    \input{sections/02_Objetivos_Alcance}
    \input{sections/03_Contexto_Estado}
    \input{sections/04_Metodologia}
    
    \input{sections/05_Analisis_Requisitos}
    \input{sections/06_Disenio}
    \input{sections/07_Implementacion}
    \input{sections/08_Evaluacion_Exp}
    ...
    % Anexos
    \cleardoublepage
    \input{sections/10_Declaracion_IA}
